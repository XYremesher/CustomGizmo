// https://github.com/networked-aframe/networked-aframe/blob/master/server/uws-server.cjs
// @16f35e7
...
function serveStatic(res, reqPath) {
  reqPath = reqPath.replaceAll(/%20/g, " ");
  let filepath = path.join(__dirname, "..", "client", reqPath);
